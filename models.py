...
SITE_TEXT_CATALOG: list[dict] = [
    ...
    },
    {
        ...
        "kind": "textarea",
        "default": "Аксай Гриль — это живое место с огнём, вкусом и домашней кухней в самом сердце Аксайского района.",
        "section": "Страница «О нас»",
    },
    {
        ...
        "kind": "text",
        "default": "История нашего предприятия насчитывает уже более двух лет успешной работы",
        "section": "Страница «О нас»",
    },
    {
        ...
        "kind": "textarea",
        "default": (
            "Предприятие общественного питания «Аксай Гриль» работает на рынке Аксайского района "
            "уже более двух лет. За это время мы стали любимым местом для жителей и гостей района, "
            "которые ценят настоящий вкус, домашнюю кухню и искреннее гостеприимство."
        ),
        "section": "Страница «О нас»",
    },
    {
        ...
        "kind": "textarea",
        "default": (
            "Мы расположены на рынке «Казачий» — в удобном месте с просторной парковкой, "
            "на перекрёстке трёх дорог. Совсем рядом новый микрорайон Придонье с численностью "
            "жителей около 120\u202f000 человек: до нас легко дойти пешком или подъехать "
    ...
    },
    {
        ...
        "kind": "text",
        "default": "Домашние продукты и свежайшее мясо",
        "section": "Страница «О нас»",
    },
    {
        ...
        "kind": "textarea",
        "default": (
            "Мы готовим только из натуральных домашних продуктов и мяса высочайшей свежести. "
            "Никаких заморозок, никаких полуфабрикатов — каждое блюдо создаётся здесь и сейчас, "
            "чтобы вы получили настоящий вкус."
        ),
        "section": "Страница «О нас»",
    },
    {
