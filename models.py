...
_MENU_SEED: list[dict] = [
    ...
    },
    {
        ...
        "dishes": [
            ("Борщ", "Классический наваристый борщ со свеклой, нежной говядиной и свежей зеленью.", 220, "/assets/dishes/borshch.jpg"),
            ("Шурпа", "Традиционный восточный суп с крупными кусками баранины и овощами.", 250, "/assets/dishes/shurpa.jpg"),
